...
<?php
	...
	echo HTML::link('Cetak Kartu',array('print','id'=>$model->PAS_NOREKAMMEDIK));
...
<?php
		...
		echo HTML::link('Tambah Rekam Medik',array('rekammedik/create','id'=>$model->PAS_NOREKAMMEDIK));		
		echo '<br/>';
		echo '<br/>';
		$this->widget('zii.widgets.grid.CGridView', array(
			...
			'columns'=>array(
				...
				array(
					...
					'header'=>'Aksi',
					'template'=>$template,
					'viewButtonUrl'=>'\'index.php?r=Pendaftaran/rekammedik/view&id=\'.$data->PAS_NOREKAMMEDIK.\'&tglkunjungan=\'.$data->REM_TGLKUNJUNGAN',
					'updateButtonUrl'=>'\'index.php?r=Pendaftaran/rekammedik/update&id=\'.$data->PAS_NOREKAMMEDIK.\'&tglkunjungan=\'.$data->REM_TGLKUNJUNGAN',
					'deleteButtonUrl'=>'\'index.php?r=Pendaftaran/rekammedik/delete&id=\'.$data->PAS_NOREKAMMEDIK.\'&tglkunjungan=\'.$data->REM_TGLKUNJUNGAN',
				),
			),
		));
?>