				...
				<select name="dokter">
							<?php
								foreach($dokter as $dokter){
									echo "<option>" .$dokter->DOK_NAMADOKTER;
								}
							?>
						</select>
			</td>
...
<table>
	...
	<div class="row buttons">
		...
		&nbsp;
		<?php echo CHtml::link('Batal',array('rekammedik/view','id'=>$rekammedik->PAS_NOREKAMMEDIK,'tglkunjungan'=>$rekammedik->REM_TGLKUNJUNGAN)); ?>
	</div>
